...
public class StatusBarUtils {
    ...
    public static void setTranslucent(Activity activity, int alpha, View needOffsetView){
        setFullScreen(activity);
        //获取windowphone下的decorView
        ViewGroup decorView = (ViewGroup) activity.getWindow().getDecorView();
        int       count     = decorView.getChildCount();
    ...
    public static void setTranslucent(Activity activity, int alpha){
      setTranslucent(activity,alpha,null);
    }
...
//                setStatusBarColor(activity,colorId);
    ...
    public static void ClearStatusBarLightMode(Activity activity, int type) {
        if (type == 1) {
            ...
            activity.getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN |View.SYSTEM_UI_FLAG_VISIBLE);//全屏
