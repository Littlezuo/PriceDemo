...
import com.jaydenxiao.common.compressorutils.AESOperator;
import com.jaydenxiao.common.httpconfig.exception.CusException;
...
//                });
        ...
        if (!NetWorkUtils.isNetConnected(BaseApplication.getAppContext())) {
            ToastUitl.showShort("数据加载失败,请重新加载或者检查网络是否链接");
            return fromCache;
        }
